...
| Project Title                               | Industries/Fields                               | Roles                                    | Skills and Tools                | Project Objectives                                                                | Project Description     |
|---------------------------------------------|-------------------------------------------------|------------------------------------------|----------------------------------|------------------------------------------------------------------------------------|-------------------------|
| Data Exploration of "Yandex.Music" Service  | Internet Services, Streaming Service             | Data Analyst                            | Pandas, Python                  | Analyze real data from Yandex.Music using the Pandas library to examine user behavior and preferences in two major Russian cities, Moscow and St. Petersburg. | Comparing Moscow and St. Petersburg is surrounded by myths: - Moscow is a metropolis subject to the rigid rhythm of the workweek; - St. Petersburg is a city of a unique culture, unlike Moscow. Some myths reflect reality, while others are empty stereotypes. Businesses must distinguish between the two in order to make rational decisions. Using real data from Yandex.Music, you will verify the data and compare user behavior in the two cities.
| Exploring the Creditworthiness of Borrowers | Banking, Credit Services                         | Data Analyst, Financial Analyst           | Pandas, Python, Data Preprocessing | Based on statistics on client creditworthiness, investigate whether a client's marital status and the number of children affect their ability to repay a loan on time. | Based on data from the bank's credit department, investigate the impact of marital status and the number of children on loan repayment. Data was collected, missing values were handled, data types were converted to match the stored data, duplicates were removed, and the data was categorized. One dataframe was decomposed into three.
